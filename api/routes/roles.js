...
const role_privileges = require("../config/role_priviliges");
...
router.post("/update", async (req, res) => {
    ...
    try{
        ...
        if(!body._id) throw new CustomError(Enum.HTTP_CODES.BAD_REQUEST, "Validation Error!", "Role name field must be filled");
        let updates ={};
